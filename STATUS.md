...
| **Qwen3-14B obfusqué direct (03/09, sans FT)** | verify corr 0,96-0,98 ; VMA gate **10,5 %** / We·Wh **0 %** / combiné 7,05 % ; **frwiki +6,8 %** (vs +13-21 % 8B) ; résumés fidélité 4,83 / couverture 4,17 / **structure 5,0** (chat template enable_thinking=False) | notebook cellule 35 (10.7) |
...
conforme au papier 13-25 % ; vue W_e·W_h : **0 %** ; vote combiné
**6,55 %** — la gate reste la vue la plus forte) — **α_e=0,3 est
